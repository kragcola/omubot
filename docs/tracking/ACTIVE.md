...
- status: Agent Runtime v2 默认关闭 fence release 已于 2026-08-15 上线：`ba32cdf` / image `6dc8ab9e8a30…`。本轮 bot-only 行为与 QZone ownership 修复已于 2026-08-16 上线：`d311056` / image `60f179753e94…`，交叉 199 passed、全仓 5729 passed / 17 skipped；新 bot restart=0，Admin=200，Runtime unauth=401，production JSON config 无 `agent_runtime`，storage 无 Runtime source。NapCat 未重启或重建，ID/image/start/restart 均不变。
