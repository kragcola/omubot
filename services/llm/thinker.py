...
## 输出格式
只输出一行 JSON：
{{"action": "reply|wait", "retrieve_mode": "skip|doc|fact|hybrid", "thought": "你的简短思考（30字以内）", "sticker": true/false, "tone": "元气|日常|安慰|认真"}}"""  # noqa: E501


class ThinkDecision:
    """Parsed thinker output."""
    __slots__ = ("action", "retrieve_mode", "sticker", "thought", "tone", "usage")
