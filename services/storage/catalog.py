...
DEFAULT_DATABASE_CATALOG = DatabaseCatalog(
    (
        ...
        _spec(
            "entity_aliases",
            "storage/entity_aliases.db",
            "services.memory.entity_alias_store",
            clients=(
                "services.memory.entity_alias_store",
                "services.memory_consolidator.promoter",
                "services.tools.affection_tools",
            ),
            critical=True,
        ),
        _spec(
        ...
        _spec(
            "messages",
            "storage/messages.db",
            "services.conversation_archive.store",
            clients=("services.conversation_archive.store", "services.memory.message_log"),
            connection=ConnectionProfile.DELETE_FULL,
            retention=RetentionProfile.OWNER_MANAGED,
            critical=True,
        ),
        ...
        _spec(
            ...
            "storage/research_topic_assignments.db",
            "services.group.topic_assignment_store",
            backup=BackupProfile.REBUILDABLE,
            retention=RetentionProfile.REBUILDABLE,
            optional=True,
            sensitive=True,
